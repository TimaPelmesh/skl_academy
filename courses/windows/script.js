...
(function themeAndColorSwitcher() {
    ...
    const savedTheme = localStorage.getItem('windows-course-theme');
    const savedColorScheme = localStorage.getItem('windows-course-color-scheme');
    ...
    if (themeToggle) {
        themeToggle.addEventListener('click', () => {
            ...
            localStorage.setItem('windows-course-theme', theme);
        });
    }
    ...
    colorSchemeButtons.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            localStorage.setItem('windows-course-color-scheme', colorScheme);
        });
    });
})();
...
(function() {
    ...
    function syncMobileColorScheme() {
        const activeColor = localStorage.getItem('windows-course-color-scheme');
