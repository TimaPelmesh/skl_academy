...
// Инициализация состояния сайдбара в зависимости от размера экрана
...
function initSidebarInteractions() {
    // Добавляем обработчики событий для кнопок модулей
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        // Инициализация sidebar взаимодействий
        initSidebarInteractions();
        
        // Инициализация отслеживания активных секций
        setActiveSection();
    }, 100);
});
...
// Кнопка контакта (i) и карточка – авто-добавление для страниц курса Python
(function contactFabPython() {
...
(function themeAndColorSwitcher() {
    ...
    const savedTheme = localStorage.getItem('python-course-theme');
    const savedColorScheme = localStorage.getItem('python-course-color-scheme');
    ...
    if (themeToggle) {
        themeToggle.addEventListener('click', () => {
            ...
            localStorage.setItem('python-course-theme', theme);
        });
    }
    ...
    colorSchemeButtons.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            localStorage.setItem('python-course-color-scheme', colorScheme);
        });
    });
})();
...
(function() {
    ...
    function syncMobileColorScheme() {
        const activeColor = localStorage.getItem('python-course-color-scheme');
