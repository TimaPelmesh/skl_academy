...
(function themeAndColorSwitcher() {
    ...
    const savedTheme = localStorage.getItem('networks-course-theme');
    const savedColorScheme = localStorage.getItem('networks-course-color-scheme');
    ...
    if (themeToggle) {
        themeToggle.addEventListener('click', () => {
            ...
            localStorage.setItem('networks-course-theme', theme);
        });
    }
    ...
    colorSchemeButtons.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            localStorage.setItem('networks-course-color-scheme', colorScheme);
        });
    });
})();
...
(function() {
    ...
    function syncMobileColorScheme() {
        const activeColor = localStorage.getItem('networks-course-color-scheme');
...
// Кнопка контакта (i) и карточка – авто-добавление для страниц курса Networks
(function contactFabNetworks() {
